...
{
    public class YingshiOrderController : Controller
    {
        ...
        [UserAuthorize]
        [HttpGet]
        public ActionResult AddYingshi(int id)
        {         
        ...
        [UserAuthorize]
        [HttpGet]
        public ActionResult AddYingshiInfo()
        {
        ...
        [UserAuthorize]
        [HttpGet]
        public ActionResult ViewYingshi()
        {
