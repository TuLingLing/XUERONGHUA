...
namespace Ed.Web
{
public  class PregnanterInfoApiController:ApiController
    {
	#region  依赖注入(PregnanterInfoApiController注入PregnanterInfoService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(PregnanterInfoApiController注入PregnanterInfoService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IPregnanterInfoService   PregnanterInfoService = (IPregnanterInfoService ) ContextRegistry.GetContext().GetObject("pregnanterInfoService");
	    ...
	    #region 获取所有PregnanterInfo列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有PregnanterInfo列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TPregnanterInfo> GetPregnanterInfos(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid PregnanterInfo列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/PregnanterInfoApi/GetBootGridPregnanterInfos?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid PregnanterInfo列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        /// <summary>
        /// 获取PregnanterInfoZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条PregnanterInfo数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        /// <returns>ResponseMessage</returns>
        [HttpPost]
        public ResponseMessage UpdatePregnanterInfoStatus(int ids)
        {
            ResponseMessage rmsg = new ResponseMessage();
             if (PregnanterInfoService.UpdateEntityStatus(null,null))
                        {
                            rmsg.Status = true;
                        }
                        else
