...
public  class OrderApiController:ApiController
    {
	#region  依赖注入(OrderApiController注入OrderService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(OrderApiController注入OrderService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IOrderService   OrderService = (IOrderService ) ContextRegistry.GetContext().GetObject("orderService");
	    ...
	    #region 获取所有Order列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有Order列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TOrder> GetOrders(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid Order列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/OrderApi/GetBootGridOrders?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid Order列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        /// <summary>
        /// 获取OrderZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条Order数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        /// <returns>ResponseMessage</returns>
        [HttpPost]
        public ResponseMessage UpdateOrderStatus(int ids)
        {
            ResponseMessage rmsg = new ResponseMessage();
             if (OrderService.UpdateEntityStatus(null,null))
                        {
                            rmsg.Status = true;
                        }
                        else
        ...
        // /api/OrderApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (OrderService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
