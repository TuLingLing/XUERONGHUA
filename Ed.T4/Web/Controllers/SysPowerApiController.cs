...
public  class SysPowerApiController:ApiController
    {
	#region  依赖注入(SysPowerApiController注入SysPowerService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(SysPowerApiController注入SysPowerService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly ISysPowerService   SysPowerService = (ISysPowerService ) ContextRegistry.GetContext().GetObject("sysPowerService");
	    ...
	    #region 获取所有SysPower列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有SysPower列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TSysPower> GetSysPowers(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid SysPower列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/SysPowerApi/GetBootGridSysPowers?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid SysPower列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridSysPowers()
        {
            ...
            //获取数据
            List<Dictionary<string, object>> sysPowers =
                SysPowerService.GetSysPowerList(current, rowCount, selector, predicate, ordering,
                    out total, values);
             //空值处理
            if (null == sysPowers)
            {
                sysPowers=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取SysPowerZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条SysPower数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/SysPowerApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (SysPowerService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
