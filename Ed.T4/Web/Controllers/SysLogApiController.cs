...
public  class SysLogApiController:ApiController
    {
	#region  依赖注入(SysLogApiController注入SysLogService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(SysLogApiController注入SysLogService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly ISysLogService   SysLogService = (ISysLogService ) ContextRegistry.GetContext().GetObject("sysLogService");
	    ...
	    #region 获取所有SysLog列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有SysLog列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TSysLog> GetSysLogs(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid SysLog列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/SysLogApi/GetBootGridSysLogs?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid SysLog列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridSysLogs()
        {
            ...
            if (null == sysLogs)
            {
                sysLogs=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取SysLogZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条SysLog数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/SysLogApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (SysLogService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
