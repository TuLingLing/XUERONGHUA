...
public  class SysUserApiController:ApiController
    {
	#region  依赖注入(SysUserApiController注入SysUserService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(SysUserApiController注入SysUserService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly ISysUserService   SysUserService = (ISysUserService ) ContextRegistry.GetContext().GetObject("sysUserService");
	    ...
	    #region 获取所有SysUser列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有SysUser列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TSysUser> GetSysUsers(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid SysUser列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/SysUserApi/GetBootGridSysUsers?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid SysUser列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridSysUsers()
        {
            ...
            if (null == sysUsers)
            {
                sysUsers=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取SysUserZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条SysUser数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
