...
public  class PregnanterEvaluationApiController:ApiController
    {
	#region  依赖注入(PregnanterEvaluationApiController注入PregnanterEvaluationService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(PregnanterEvaluationApiController注入PregnanterEvaluationService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IPregnanterEvaluationService   PregnanterEvaluationService = (IPregnanterEvaluationService ) ContextRegistry.GetContext().GetObject("pregnanterEvaluationService");
	    ...
	    #region 获取所有PregnanterEvaluation列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有PregnanterEvaluation列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TPregnanterEvaluation> GetPregnanterEvaluations(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid PregnanterEvaluation列表 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取Bootgrid PregnanterEvaluation列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridPregnanterEvaluations()
        {
            ...
            List<Dictionary<string, object>> pregnanterEvaluations =
                PregnanterEvaluationService.GetPregnanterEvaluationList(current, rowCount, selector, predicate, ordering,
                    out total, values);
             //空值处理
            if (null == pregnanterEvaluations)
            {
                pregnanterEvaluations=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取PregnanterEvaluationZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条PregnanterEvaluation数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/PregnanterEvaluationApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (PregnanterEvaluationService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
