...
namespace Ed.Web
{
public  class PregnanterServiceRecordApiController:ApiController
    {
	#region  依赖注入(PregnanterServiceRecordApiController注入PregnanterServiceRecordService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(PregnanterServiceRecordApiController注入PregnanterServiceRecordService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IPregnanterServiceRecordService   PregnanterServiceRecordService = (IPregnanterServiceRecordService ) ContextRegistry.GetContext().GetObject("pregnanterServiceRecordService");
	    ...
	    #region 获取所有PregnanterServiceRecord列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有PregnanterServiceRecord列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TPregnanterServiceRecord> GetPregnanterServiceRecords(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
            int total = 0;
            //分页
            ...
            var models = PregnanterServiceRecordService.GetPregnanterServiceRecordList(current, rowCount, out total, predicate, dataOrders).AsEnumerable();
            return models;
	    }
		
        #endregion

		 #region  获取Bootgrid PregnanterServiceRecord列表 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取Bootgrid PregnanterServiceRecord列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        /// <summary>
        /// 获取PregnanterServiceRecordZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条PregnanterServiceRecord数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/PregnanterServiceRecordApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
