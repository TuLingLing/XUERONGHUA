...
public  class SysDepartmentApiController:ApiController
    {
	#region  依赖注入(SysDepartmentApiController注入SysDepartmentService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(SysDepartmentApiController注入SysDepartmentService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly ISysDepartmentService   SysDepartmentService = (ISysDepartmentService ) ContextRegistry.GetContext().GetObject("sysDepartmentService");
	    ...
	    #region 获取所有SysDepartment列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有SysDepartment列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TSysDepartment> GetSysDepartments(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid SysDepartment列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/SysDepartmentApi/GetBootGridSysDepartments?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid SysDepartment列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridSysDepartments()
        {
            ...
            List<Dictionary<string, object>> sysDepartments =
                SysDepartmentService.GetSysDepartmentList(current, rowCount, selector, predicate, ordering,
                    out total, values);
             //空值处理
            if (null == sysDepartments)
            {
                sysDepartments=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取SysDepartmentZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条SysDepartment数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
