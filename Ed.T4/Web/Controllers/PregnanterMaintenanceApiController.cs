...
public  class PregnanterMaintenanceApiController:ApiController
    {
	#region  依赖注入(PregnanterMaintenanceApiController注入PregnanterMaintenanceService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(PregnanterMaintenanceApiController注入PregnanterMaintenanceService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IPregnanterMaintenanceService   PregnanterMaintenanceService = (IPregnanterMaintenanceService ) ContextRegistry.GetContext().GetObject("pregnanterMaintenanceService");
	    ...
	    #region 获取所有PregnanterMaintenance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有PregnanterMaintenance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TPregnanterMaintenance> GetPregnanterMaintenances(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid PregnanterMaintenance列表 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取Bootgrid PregnanterMaintenance列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        /// <summary>
        /// 获取PregnanterMaintenanceZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条PregnanterMaintenance数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/PregnanterMaintenanceApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (PregnanterMaintenanceService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
