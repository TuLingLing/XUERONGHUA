...
public  class ClientInfoApiController:ApiController
    {
	#region  依赖注入(ClientInfoApiController注入ClientInfoService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(ClientInfoApiController注入ClientInfoService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IClientInfoService   ClientInfoService = (IClientInfoService ) ContextRegistry.GetContext().GetObject("clientInfoService");
	#endregion
	    ...
	    #region 获取所有ClientInfo列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有ClientInfo列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TClientInfo> GetClientInfos(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
            int total = 0;
            //分页
            ...
            var models = ClientInfoService.GetClientInfoList(current, rowCount, out total, predicate, dataOrders).AsEnumerable();
            return models;
	    }
		
        #endregion

		 #region  获取Bootgrid ClientInfo列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/ClientInfoApi/GetBootGridClientInfos?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid ClientInfo列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridClientInfos()
        {
            ...
            List<Dictionary<string, object>> clientInfos =
                ClientInfoService.GetClientInfoList(current, rowCount, selector, predicate, ordering,
                    out total, values);
             //空值处理
            if (null == clientInfos)
            {
                clientInfos=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取ClientInfoZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条ClientInfo数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        /// <returns>ResponseMessage</returns>
        [HttpPost]
        public ResponseMessage UpdateClientInfoStatus(int ids)
        {
            ResponseMessage rmsg = new ResponseMessage();
             if (ClientInfoService.UpdateEntityStatus(null,null))
                        {
                            rmsg.Status = true;
                        }
                        else
