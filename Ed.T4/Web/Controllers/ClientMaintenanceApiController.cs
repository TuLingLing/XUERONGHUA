...
public  class ClientMaintenanceApiController:ApiController
    {
	#region  依赖注入(ClientMaintenanceApiController注入ClientMaintenanceService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(ClientMaintenanceApiController注入ClientMaintenanceService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IClientMaintenanceService   ClientMaintenanceService = (IClientMaintenanceService ) ContextRegistry.GetContext().GetObject("clientMaintenanceService");
	    ...
	    #region 获取所有ClientMaintenance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有ClientMaintenance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TClientMaintenance> GetClientMaintenances(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid ClientMaintenance列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/ClientMaintenanceApi/GetBootGridClientMaintenances?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid ClientMaintenance列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridClientMaintenances()
        {
            ...
            List<Dictionary<string, object>> clientMaintenances =
                ClientMaintenanceService.GetClientMaintenanceList(current, rowCount, selector, predicate, ordering,
                    out total, values);
             //空值处理
            if (null == clientMaintenances)
            {
                clientMaintenances=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取ClientMaintenanceZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条ClientMaintenance数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/ClientMaintenanceApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (ClientMaintenanceService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
