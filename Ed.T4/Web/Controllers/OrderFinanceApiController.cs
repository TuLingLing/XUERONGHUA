...
public  class OrderFinanceApiController:ApiController
    {
	#region  依赖注入(OrderFinanceApiController注入OrderFinanceService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(OrderFinanceApiController注入OrderFinanceService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly IOrderFinanceService   OrderFinanceService = (IOrderFinanceService ) ContextRegistry.GetContext().GetObject("orderFinanceService");
	    ...
	    #region 获取所有OrderFinance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有OrderFinance列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TOrderFinance> GetOrderFinances(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
            int total = 0;
            //分页
            ...
            var models = OrderFinanceService.GetOrderFinanceList(current, rowCount, out total, predicate, dataOrders).AsEnumerable();
            return models;
	    }
		
        #endregion

		 #region  获取Bootgrid OrderFinance列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/OrderFinanceApi/GetBootGridOrderFinances?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid OrderFinance列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        /// <summary>
        /// 获取OrderFinanceZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条OrderFinance数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/OrderFinanceApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
