...
public  class SysRoleApiController:ApiController
    {
	#region  依赖注入(SysRoleApiController注入SysRoleService) 2014-10-29 20:15:31 By 唐有炜
	 /// <summary>
     /// 依赖注入(SysRoleApiController注入SysRoleService) 2014-10-29 20:15:31 By 唐有炜
     /// </summary>
	 private readonly ISysRoleService   SysRoleService = (ISysRoleService ) ContextRegistry.GetContext().GetObject("sysRoleService");
	    ...
	    #region 获取所有SysRole列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
		...
		/// <summary>
        /// 获取所有SysRole列表（默认前10条） 2014-10-29 20:15:315 By 唐有炜
        /// </summary>
        ...
        public IEnumerable<TSysRole> GetSysRoles(int? pageIndex, int? pageSize, string sortField, string sortType,string searchPhrase, string format)
        {
		 ...
		 #region  获取Bootgrid SysRole列表 2014-10-29 20:15:31 By 唐有炜
	
        //POST /api/SysRoleApi/GetBootGridSysRoles?current=1&rowCount=10&sort[field_name]=DESC&searchPhrase=
        /// <summary>
        /// 获取Bootgrid SysRole列表 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        ...
        public BootGrid GetBootGridSysRoles()
        {
            ...
            if (null == sysRoles)
            {
                sysRoles=new List<Dictionary<string, object>>();
            }
        ...
        /// <summary>
        /// 获取SysRoleZTree树形节点 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
        /// <returns>json</returns>
        [HttpPost]
	   ...
	   #region 查看 2014-10-29 20:15:31 By 唐有炜
        ...
        /// <summary>
        /// 获取一条SysRole数据 2014-10-29 20:15:31 By 唐有炜
        /// </summary>
	  ...
	  #region 添加、修改 2014-10-29 20:15:31 By 唐有炜
       ...
       /// <returns>ResponseMessage</returns>
        ...
        // /api/SysRoleApi/Validate?fields=1&eqs=&values=&operations=2
        /// <summary>
        ...
        public HttpResponseMessage Validate(string fields, string eqs, string values, string operations,bool existReturn=true)
        {
			...
			//发送请求
            if (SysRoleService.Validate(predicate,parms))
            {
                Status = true;
            }
            else
