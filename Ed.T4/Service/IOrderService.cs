...
public  interface IOrderService
    {
        ...
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TOrder> GetOrderList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetOrderList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetOrderList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetOrderList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TOrder GetOrder(Expression<Func<TOrder, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetOrder(string selector, string expFields, string expSelector, string predicate,
