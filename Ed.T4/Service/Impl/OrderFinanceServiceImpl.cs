...
public  class OrderFinanceServiceImpl: IOrderFinanceService
	...
	public ITOrderFinanceDao  OrderFinanceDao{set;get;}
      ...
      public  List<Dictionary<string, object>>  GetOrderFinanceList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
       ...
       public List<Dictionary<string, object>> GetOrderFinanceList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values)
	   {
	  
	   try
                {
                var models = OrderFinanceDao.GetListWithExpByPage(pageIndex, pageSize, selector, expFields, expSelector, predicate,
                ordering,out recordCount, values);
				   LogHelper.Debug("获取OrderFinance分页列表成功。");
                return models;
                }
	...
	try
      ...
      public  Dictionary<string, object> GetOrderFinance(string selector, string expFields, string expSelector, string predicate,
