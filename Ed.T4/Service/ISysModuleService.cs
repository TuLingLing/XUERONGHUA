...
public  interface ISysModuleService
    {
        ...
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TSysModule> GetSysModuleList( int pageIndex, int pageSize, out int recordCount,
        ...
        DataTable GetSysModuleList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
        ...
        List<Dictionary<string, object>>  GetSysModuleList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
        ...
        List<Dictionary<string, object>> GetSysModuleList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TSysModule GetSysModule(Expression<Func<TSysModule, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetSysModule(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddSysModule(TSysModule SysModule);
        ...
        /// <param name="id">id</param>
         /// <param name="TSysModule">TSysModule</param>
        /// <returns>添加状态</returns>
        bool EditSysModule(TSysModule SysModule);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteSysModule(string ids);
