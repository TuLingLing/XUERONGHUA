...
namespace  Ed.Dao.Impl
{
    ...
    /// <summary>
    /// 自动生成的实现ITSysLogDao接口的Dao类。 2014-10-20 04:45:28 By 唐有炜
    /// </summary>
 public class TSysLogDaoImpl:ITSysLogDao
   ...
   #region 写操作
       ...
       /// <summary>
        ...
        /// <summary>
        /// 使用LINQ批量更改TSysLog状态 2014-09-05 14:58:50 By 唐有炜
        /// </summary>
		 ...
		 using (EdDBContext db=new EdDBContext())
            {
                ...
                try
                {
                    ...
                    {
                     var entity = db.TSysLogs.Where(predicate,values).FirstOrDefault();
