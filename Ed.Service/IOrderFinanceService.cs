...
{
/// <summary>
/// Interface IOrderFinanceService
/// </summary>
public  interface IOrderFinanceService
    {
	    #region 逻辑接口 2014-10-28 10:57:05 By 唐有炜

		 /// <summary>
        /// 获取信息分页列表（IEnumerable<Model>） 2014-10-28 10:57:05 By 唐有炜
        /// </summary>
        ...
        /// <param name="predicate">筛选条件</param>
         IEnumerable<TOrderFinance> GetOrderFinanceList( int pageIndex, int pageSize, out int recordCount,
            Expression<Func<TOrderFinance, bool>> predicate,IDictionary<string, Ed.Entity.EdEnums.OrderEmum> orders
            );
			/// <summary>
        /// 获取信息分页列表（IEnumerable<Model>，动态LINQ） 2014-10-28 10:57:05 By 唐有炜
        /// </summary>
        /// <param name="pageIndex">页码</param>
        /// <param name="pageSize">每页的数目</param>
        /// <param name="recordCount">总数（用out返回便于后面使用）</param>
        ...
        /// <summary>
        /// 获取信息分页列表(DataTable) 2014-10-28 10:57:05 By 唐有炜
        /// </summary>
        /// <param name="pageIndex">页码</param>
        /// <param name="pageSize">每页的数目</param>
        ...
        DataTable GetOrderFinanceList(string[] selectFields, int pageIndex, int pageSize, out int recordCount,
		  ...
		  /// <summary>
        /// 查询分页（可以自定义添加属性，不包括扩展字段） 2014-10-28 10:57:05 By 唐有炜
        /// </summary>
        /// <param name="pageIndex">页码</param>
        /// <param name="pageSize">每页的数目</param>
        ...
        List<Dictionary<string, object>>  GetOrderFinanceList(int pageIndex, int pageSize, string selector,string predicate, string ordering,
            out int recordCount, params object[] values);


        /// <summary>
        /// 获取信息分页列表List<Dictionary<string, object>> 2014-10-28 10:57:05 By 唐有炜
        /// </summary>
        /// <param name="pageIndex">页码</param>
        /// <param name="pageSize">每页的数目</param>
        /// <param name="selector">要查询的字段</param>
        ...
        List<Dictionary<string, object>> GetOrderFinanceList( string selector, string expFields, string expSelector,int pageIndex, int pageSize, out int recordCount,string predicate, string ordering,params object[] values);
       ...
       TOrderFinance GetOrderFinance(Expression<Func<TOrderFinance, bool>> predicate);
      ...
      /// <summary>
       ...
       /// <param name="selector">要查询的字段</param>
        ...
        Dictionary<string, object> GetOrderFinance(string selector, string expFields, string expSelector, string predicate,
	...
	IQueryable<Object> GetFields(string selector, string predicate);
        ...
        bool AddOrderFinance(TOrderFinance OrderFinance);
        ...
        /// <param name="id">id</param>
         /// <param name="TOrderFinance">TOrderFinance</param>
        /// <returns>添加状态</returns>
        bool EditOrderFinance(TOrderFinance OrderFinance);
       ...
       /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        ...
        bool DeleteOrderFinance(string ids);
    ...
    /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
    bool AddYuesaoOrderFinanceTran(TOrderFinance orderFinance);
